...
namespace wardrobeProject_test1.Controllers
{
    public class TopsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TopsID,Nickname,Photo,Type,Color,Season,Occasion")] Tops tops)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TopsID,Nickname,Photo,Type,Color,Season,Occasion")] Tops tops)
        {
            if (ModelState.IsValid)
            {
