...
namespace wardrobeProject_test1.Controllers
{
    ...
    {
        public ActionResult ManageBottom()
        {
        ...
        public ActionResult Create([Bind(Include = "AccessoryID,Nickname,Photo,Type,Color,Season,Occasion")] Bottom bottom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AccessoryID,Nickname,Photo,Type,Color,Season,Occasion")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
