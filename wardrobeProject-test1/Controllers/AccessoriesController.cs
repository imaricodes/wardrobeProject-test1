...
namespace wardrobeProject_test1.Controllers
{
    ...
    {
      public ActionResult ManageAccessory()
        {
        ...
        public ActionResult Create([Bind(Include = "AccessoryID,Nickname,Photo,Type,Color,Season,Occasion")] Accessory accessory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AccessoryID,Nickname,Photo,Type,Color,Season,Occasion")] Accessory accessory)
        {
            if (ModelState.IsValid)
            {
